...
# ACDS 18.1 646 win32 2024.01.24.09:46:25
# ----------------------------------------
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/lab2_nios2_gen2_0_cpu_bht_ram.dat ./
  file copy -force $QSYS_SIMDIR/submodules/lab2_nios2_gen2_0_cpu_bht_ram.hex ./
  file copy -force $QSYS_SIMDIR/submodules/lab2_nios2_gen2_0_cpu_bht_ram.mif ./
  file copy -force $QSYS_SIMDIR/submodules/lab2_nios2_gen2_0_cpu_dc_tag_ram.dat ./
  file copy -force $QSYS_SIMDIR/submodules/lab2_nios2_gen2_0_cpu_dc_tag_ram.hex ./
  file copy -force $QSYS_SIMDIR/submodules/lab2_nios2_gen2_0_cpu_dc_tag_ram.mif ./
  file copy -force $QSYS_SIMDIR/submodules/lab2_nios2_gen2_0_cpu_ic_tag_ram.dat ./
  file copy -force $QSYS_SIMDIR/submodules/lab2_nios2_gen2_0_cpu_ic_tag_ram.hex ./
  file copy -force $QSYS_SIMDIR/submodules/lab2_nios2_gen2_0_cpu_ic_tag_ram.mif ./
...
alias com {
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/lab2_mm_interconnect_0_rsp_demux_001.sv"                     -work rsp_demux_001                               
  ...
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/lab2_nios2_gen2_0_cpu.vo"                                    -work cpu                                         
  ...
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/lab2_nios2_gen2_0_cpu_mult_cell.v"                           -work cpu                                         
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/lab2_rst_controller.vhd"                                                                                                  
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/lab2_rst_controller_001.vhd"                                                                                              
}
